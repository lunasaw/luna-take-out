...
function loadMenu() {
    ...
    if (admin.trim() == "0") {
        ...
        msg = [];
        var json = '[{"id": "1","name": "CSI餐厅小筑外卖网","icon": null,"url": "","parentId": "","childs": [{"id": "11","name": "菜系管理","icon": "/xingxing.png","url": "mealseriesManage.html","parentId": "4","childs": []},{"id": "12","name": "餐品管理","icon": "/xingxing.png","url": "mealManage.html","parentId": "4","childs": []},{"id": "13","name": "订单管理","icon": "/xingxing.png","url": "ordersManage.html","parentId": "4","childs": []},{"id": "14","name": "用户管理","icon": "/xingxing.png","url": "usersManage.html","parentId": "4","childs": [{"id": "141","name": "普通用户","icon": "","url": "usersManage.html","parentId": "14","childs": []},{"id": "142","name": "管理员","icon": "","url": "adminManage.html","parentId": "14","childs": []}]}]}]';
        // jquery的方法
        ...
        $("#editPasswordId").attr("data-href", "adminEditPassword.html");
        $("#faceRegisterId").attr("data-href", "adminFaceRegister.html");
        $("#aaa").attr("style", "display:none;");//隐藏di
    } else {
        msg = [];
        var json = '[{"id": "1","name": "贴吧","icon": null,"url": "","parentId": "","childs": [{"id": "11","name": "菜单","icon": "/xingxing.png","url": "meal.html","parentId": "4","childs": []},{"id": "12","name": "我的购物车","icon": "/xingxing.png","url": "cart.html","parentId": "4","childs": []},{"id": "14","name": "我的订单","icon": "/xingxing.png","url": "myOrders.html","parentId": "4","childs": []},{"id": "16","name": "个人设置","icon": "/xingxing.png","url": "editUser.html","parentId": "4","childs": []}]}]';
        // jquery的方法
        var jsonObj = $.parseJSON(json)
        ...
        $("#editPasswordId").attr("data-href", "userEditPassword.html");
        $("#faceRegisterId").attr("data-href", "usersFaceRegister.html");
        $("#mapId").attr("data-href", "map.html");
